...
class BankManagement {
    ...
    void defaultadd() throws Exception {
        ...
        String sql6 = "INSERT INTO BankDataBase values(7,'112207','DARSHAN',53000.0,9328931902,1113)";
        int xz = st.executeUpdate(sql6);
        Bank b7 = new Bank(1113, "DARSHAN", 53000.0, "112207", "9328931902");
        mybank.put("112207", b7);
        String sql7 = "INSERT INTO BankDataBase values(8,'112208','JAY',25000.0,9328996902,1114)";
        int xy = st.executeUpdate(sql7);
        Bank b8 = new Bank(1114, "JAY", 25000.0, "112208", "9328996902");
        mybank.put("112208", b8);
        String sql8 = "INSERT INTO BankDataBase values(9,'112209','SHUBH',5000.0,9326736902,1115)";
        int xx = st.executeUpdate(sql8);
    ...
    void UPDATEPIN(String accno) throws Exception {
        if (mybank.containsKey(accno)) {
            ...
            System.out.println();
            System.out.println("ENTER OLD SECURITY PIN :");
            int pin = sc.nextInt();
            sc.nextLine();
            ...
            if (b.pin == pin) {
                ...
                br.write("PIN CHANGED FROM : " + pin + " TO -> " + newpin);
                br.newLine();
                String sql = "UPDATE BankDataBase SET PIN = " + newpin + " WHERE AccNo = '" + accno + "'";
